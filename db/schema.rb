...
ActiveRecord::Schema[7.0].define(version: 2022_12_29_193125) do
  ...
  create_table "company_vehicles", force: :cascade do |t|
    t.string "brand"
    t.string "model"
  ...
  create_table "entrances", force: :cascade do |t|
    ...
    t.bigint "company_id"
    t.index ["company_id"], name: "index_entrances_on_company_id"
  ...
  create_table "exits", force: :cascade do |t|
    ...
    t.bigint "user_id", null: false
    t.bigint "company_id"
    t.index ["company_id"], name: "index_exits_on_company_id"
  ...
  add_foreign_key "company_vehicles", "companies"
  add_foreign_key "entrances", "companies"
  add_foreign_key "entrances", "company_vehicles"
  add_foreign_key "entrances", "users"
  add_foreign_key "exits", "companies"
  add_foreign_key "exits", "company_vehicles"
  add_foreign_key "exits", "users"
end
